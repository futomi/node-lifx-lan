...
LifxLanParser.prototype._parseTile = function(buf) {
	return {
		accel_meas_x:	buf.readInt16LE(0), // signed 16-bit integer
		accel_meas_y:	buf.readInt16LE(2), // signed 16-bit integer
		accel_meas_z:	buf.readInt16LE(4), // signed 16-bit integer
		reserved:	buf.readInt16LE(6), // signed 16-bit integer
		user_x:	buf.readFloatLE(8), // 32-bit float
		user_y:	buf.readFloatLE(12), // 32-bit float
		width: buf.readUInt8(16), // unsigned 8-bit integer
		height:	buf.readUInt8(17), // unsigned 8-bit integer
		reserved:	buf.readUInt8(18), // unsigned 8-bit integer
		device_version_vendor: buf.readUInt32LE(19), // unsigned 32-bit integer
		device_version_product:	buf.readUInt32LE(23) , // unsigned 32-bit integer
		device_version_version:	buf.readUInt32LE(27), // unsigned 32-bit integer
		firmware_build:	buf.readBigUInt64LE(31), // unsigned 64-bit integer
		reserved:	buf.readBigUInt64LE(39), // unsigned 64-bit integer
		firmware_version_minor:	buf.readUInt16LE(47), // unsigned 16-bit integer
		firmware_version_major:	buf.readUInt16LE(49), // unsigned 16-bit integer
		reserved:	buf.readUInt32LE(51), // unsigned 32-bit integer
	}
};
