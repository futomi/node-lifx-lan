...
/* ------------------------------------------------------------------
* Method: tileGetDeviceChain(params)
* - params:
*   - TODO
* ---------------------------------------------------------------- */
...
/* ------------------------------------------------------------------
* Method: tileGetTilesAndBounds(params)
* - params:
*   - TODO
* ---------------------------------------------------------------- */
LifxLanDevice.prototype.tileGetTilesAndBounds = function(params) {
	let promise = new Promise((resolve, reject) => {
